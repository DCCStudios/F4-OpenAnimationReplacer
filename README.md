...
| `preserveExtractedMotion` | bool | false | Preserve the replacement `.hkx`'s extracted-motion reference frame when building the runtime clone. Use for donors authored with root motion; pose-only replacements should leave this disabled |
